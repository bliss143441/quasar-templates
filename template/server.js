...
function ssr(expressApp) {
  ...
  if (isProd) {
    ...
    // Serve static assets
    app.use(favicon(path.join(folders.public, 'statics', 'favicon.ico')))
    ...
    templatePath = path.join(folders.src, 'index.html')

    app.use(favicon(path.join(folders.src, 'statics', 'favicon.ico')))
